...
namespace IdentityServer4.Contrib.HttpClientService.Extensions
{
    ...
    public static class HttpClientServicePatchExtensions
    {
        ...
        {
            return await httpClientService.SendAsync<TRequestBody, TResponseBody>( new Uri(requestUri), HttpMethod.Patch, requestBody);
        }
        ...
        /// as <c>String</c> in the <see cref="ResponseObject{TBody}.BodyAsString"/> property.
        /// </returns>
        public static async Task<ResponseObject<TResponseBody>> PatchAsync<TResponseBody>(this HttpClientService httpClientService, string requestUri, string requestBody)
        {
            return await httpClientService.SendAsync<string, TResponseBody>(new Uri(requestUri), HttpMethod.Patch, requestBody);
        }
        ...
        /// as <c>String</c> in the <see cref="ResponseObject{TBody}.BodyAsString"/> property.
        /// </returns>
        public static async Task<ResponseObject<TResponseBody>> PatchAsync<TResponseBody>(this HttpClientService httpClientService, string requestUri, StringContent requestBody)
        {
            return await httpClientService.SendAsync<StringContent, TResponseBody>(new Uri(requestUri), HttpMethod.Patch, requestBody);
        }
        ...
        /// as <c>String</c> in the <see cref="ResponseObject{TBody}.BodyAsString"/> property.
        /// </returns>
        public static async Task<ResponseObject<TResponseBody>> PatchAsync<TResponseBody>(this HttpClientService httpClientService, string requestUri, StreamContent requestBody)
        {
            return await httpClientService.SendAsync<StreamContent, TResponseBody>(new Uri(requestUri), HttpMethod.Patch, requestBody);
        }        
    }
}