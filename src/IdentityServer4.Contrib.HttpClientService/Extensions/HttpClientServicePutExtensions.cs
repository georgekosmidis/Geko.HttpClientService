...
namespace IdentityServer4.Contrib.HttpClientService.Extensions
{
    ...
    public static class HttpClientServicePutExtensions
    {
        ...
        {
            return await httpClientService.SendAsync<string, string>(new Uri(requestUri), HttpMethod.Put, requestBody);
        }
        ...
        {
            return await httpClientService.SendAsync<string, TResponseBody>(new Uri(requestUri), HttpMethod.Put, requestBody);
        }
        ...
        {
            return await httpClientService.SendAsync<StringContent, TResponseBody>(new Uri(requestUri), HttpMethod.Put, requestBody);
        }
        ...
        {
            return await httpClientService.SendAsync<StreamContent, TResponseBody>(new Uri(requestUri), HttpMethod.Put, requestBody);
        }
    }
}