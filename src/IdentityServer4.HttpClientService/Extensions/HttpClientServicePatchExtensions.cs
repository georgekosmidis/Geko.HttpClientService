...
namespace IdentityServer4.HttpClientService.Extensions
{
    ...
    public static class HttpClientServicePatchExtensions
    {
        ...
        {
            return await httpClientService.SendAsync<TRequestBody, string>(new Uri(requestUri), HttpMethod.Patch, requestBody);
        }
        ...
        {
            return await httpClientService.SendAsync<StringContent, string>(new Uri(requestUri), HttpMethod.Patch, requestBody);
        }
        ...
        {
            return await httpClientService.SendAsync<Stream, string>(new Uri(requestUri), HttpMethod.Patch, requestBody);
        }        
    }
}