...
namespace IdentityServer4.HttpClientService.Extensions
{
    ...
    public static class HttpClientServicePostExtensions
    {
        ...
        {
            return await httpClientService.SendAsync<TResponseBody, TRequestBody>( new Uri(requestUri), HttpMethod.Post, requestBody);
        }
        ...
        /// as <c>String</c> in the <see cref="ResponseObject{TBody}.BodyAsString"/> property.
        /// </returns>
        public static async Task<ResponseObject<string>> PostAsync<TRequestBody>(this HttpClientService httpClientService, string requestUri, TRequestBody requestBody)
        {
            return await httpClientService.SendAsync<string, TRequestBody>(new Uri(requestUri), HttpMethod.Post, requestBody);
        }
        ...
        /// as <c>String</c> in the <see cref="ResponseObject{TBody}.BodyAsString"/> property.
        /// </returns>
        public static async Task<ResponseObject<string>> PostAsync(this HttpClientService httpClientService, string requestUri, StringContent requestBody)
        {
            return await httpClientService.SendAsync<string, StringContent>(new Uri(requestUri), HttpMethod.Post, requestBody);
        }
        ...
        /// as <c>String</c> in the <see cref="ResponseObject{TBody}.BodyAsString"/> property.
        /// </returns>
        public static async Task<ResponseObject<string>> PostAsync(this HttpClientService httpClientService, string requestUri, Stream requestBody)
        {
            return await httpClientService.SendAsync<string, Stream>(new Uri(requestUri), HttpMethod.Post, requestBody);
        }        
    }
}