...
using IdentityServer4.HttpClientService.SampleProject.ProtectedResourceServices.Dto;
using IdentityServer4.HttpClientService.Extensions;
using IdentityServer4.HttpClientService.Models;

namespace IdentityServer4.HttpClientService.SampleProject.ProtectedResourceServices.Services
{
    /// <summary>
